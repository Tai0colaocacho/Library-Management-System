    ...
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
        <div className="max-w-sm w-full">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" className="border-2 mt-5 border-black w-full font-semibold bg-black text-white py-2 rounded-lg hover:bg-white hover:text-black transition duration-300">LOG IN</button>
          </form>
        </div>
      </div>
      {/*RIGHT SIDE*/}
      <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
        <div className="text-center h-[400px]">
          ...
          <Link to={"/register"} className="border-2 mt-5 border-white px-8 w-full font-semibold bg-white text-black py-2 rounded-lg hover:bg-black hover:text-white transition duration-300">SIGN UP</Link>
        </div>
      </div>
    </div>
  </>);
