  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50'>
      <div className="w-full bg-white rounded-lg shadow-lg md:w-1/3">
        <div className='p-6'>
          <h3 className='text-left font-bold mb-4'>Return Book</h3>
          <form onSubmit={handleReturnBook}>
            <div className='mb-4 '>
              <label className='block text-gray-900 font-medium'>User Email</label>
              <input type='email' defaultValue={email} placeholder="Borrower's Email" className='w-full px-4 py-2 border-2 border-black rounded-md' required/>
            </div>
